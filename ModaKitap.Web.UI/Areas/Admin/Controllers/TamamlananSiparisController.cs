...
{
    public class TamamlananSiparisController : Controller
    {
        private ModaKitapDB db = new ModaKitapDB();

        // GET: Admin/TamamlananSiparis
        public ActionResult Index()
        {
            var siparis = db.Siparis.Include(s => s.Durum).Include(s => s.User).Include(s => s.UserAdres).Where(x => x.DurumID == 8).ToList();
            return View(siparis.ToList());
        }

        // GET: Admin/TamamlananSiparis/Details/5
        ...
        // GET: Admin/TamamlananSiparis/Create
        ...
        // POST: Admin/TamamlananSiparis/Create
        ...
        // GET: Admin/TamamlananSiparis/Edit/5
        ...
        // POST: Admin/TamamlananSiparis/Edit/5
        // Aşırı gönderim saldırılarından korunmak için, lütfen bağlamak istediğiniz belirli özellikleri etkinleştirin, 
        // daha fazla bilgi için https://go.microsoft.com/fwlink/?LinkId=317598 sayfasına bakın.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/TamamlananSiparis/Delete/5
        ...
        // POST: Admin/TamamlananSiparis/Delete/5
