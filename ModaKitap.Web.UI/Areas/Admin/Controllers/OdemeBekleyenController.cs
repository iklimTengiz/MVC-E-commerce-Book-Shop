...
namespace ModaKitap.Web.UI.Areas.Admin.Controllers
{
    public class OdemeBekleyenController : Controller
    {
        ...
        // GET: Admin/OdemeBekleyen
        public ActionResult Index()
        {
            var siparis = db.Siparis.Include(s => s.Durum).Include(s => s.User).Include(s => s.UserAdres).Where(x => x.DurumID == 2).ToList();
            return View(siparis.ToList());
        }

        // GET: Admin/OdemeBekleyen/Details/5
        ...
        // GET: Admin/OdemeBekleyen/Create
        ...
        // POST: Admin/OdemeBekleyen/Create
        ...
        // GET: Admin/OdemeBekleyen/Edit/5
        ...
        // POST: Admin/OdemeBekleyen/Edit/5
        // Aşırı gönderim saldırılarından korunmak için, lütfen bağlamak istediğiniz belirli özellikleri etkinleştirin, 
        // daha fazla bilgi için https://go.microsoft.com/fwlink/?LinkId=317598 sayfasına bakın.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/OdemeBekleyen/Delete/5
        ...
        // POST: Admin/OdemeBekleyen/Delete/5
