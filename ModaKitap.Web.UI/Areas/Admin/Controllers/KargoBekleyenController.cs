...
{
    public class KargoBekleyenController : Controller
    {
        private ModaKitapDB db = new ModaKitapDB();

        // GET: Admin/KargoBekleyen
        public ActionResult Index()
        {

            var siparis = db.Siparis.Include(s => s.Durum).Include(s => s.User).Include(s => s.UserAdres).Where(x => x.DurumID == 5).ToList(); 
            return View(siparis.ToList());
        }

        // GET: Admin/KargoBekleyen/Details/5
        ...
        // GET: Admin/KargoBekleyen/Create
        ...
        // POST: Admin/KargoBekleyen/Create
        ...
        // GET: Admin/KargoBekleyen/Edit/5
        ...
        // POST: Admin/KargoBekleyen/Edit/5
        // Aşırı gönderim saldırılarından korunmak için, lütfen bağlamak istediğiniz belirli özellikleri etkinleştirin, 
        // daha fazla bilgi için https://go.microsoft.com/fwlink/?LinkId=317598 sayfasına bakın.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/KargoBekleyen/Delete/5
        ...
        // POST: Admin/KargoBekleyen/Delete/5
